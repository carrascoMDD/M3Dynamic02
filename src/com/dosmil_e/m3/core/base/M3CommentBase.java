...
public class M3CommentBase
   extends com.dosmil_e.m3.core.impl.M3ElementImpl
    implements com.dosmil_e.m3.core.priv.M3CommentPriv   {
...
/****************************************************************************
 *  State storage for Attributes of the M3Comment metamodel element
 ****************************************************************************/
	protected java.lang.String vaText;




/****************************************************************************
 *  State storage for the Relationships of the M3Comment metamodel element
 ****************************************************************************/
...
/****************************************************************************
 *  Constructors of the M3Comment metamodel element
 ****************************************************************************/

  public M3CommentBase() {
    super();
  }


  public M3CommentBase( EAIMMCtxtIfc theCtxt) {
    super( theCtxt);
  }

  public M3CommentBase( EAIMMCtxtIfc theCtxt, EAIMMNameIfc theName) {
    super( theCtxt, theName);
  }


/****************************************************************************
 *  Implementation of the M3CommentIfc and M3CommentPriv interfaces
 ****************************************************************************/

/****************************************************************************
 *  Implementation of attributes of M3Comment
 ****************************************************************************/

 
/****************************************************************************
 *  Implementation of public interface for ATRRIBUTE Text
 ****************************************************************************/
  ...
  public java.lang.String getText( EAIMMCtxtIfc theCtxt) throws EAIException {
    ...
    /* Transactional Public Write accessor for attribute Text
     */
...
/****************************************************************************
 *  Implementation of internal operations for attribute Text
 ****************************************************************************/


    /* Public Read accessor for attribute Text
     */
  public java.lang.String getTextPR( EAIMMCtxtIfc theCtxt) throws EAIException {
    return vaText;
  }
     ...
     */
  public void setTextPR( EAIMMCtxtIfc theCtxt, java.lang.String theText) throws EAIException {

      // Get current value
    java.lang.String aText = getTextPR( theCtxt);
      // Check for new Text same as current one
    if( toObject( aText) != null && toObject( aText).equals( toObject( theText))) { return;}

    vaText = theText;
    change( theCtxt, "Text", toObject( aText), toObject( vaText), "vaText");
  }
...
/****************************************************************************
 *  Implementation of relationships of M3Comment
 ****************************************************************************/
 ...
 ****************************************************************************/
  ...
  public void setElementPR( EAIMMCtxtIfc theCtxt, com.dosmil_e.m3.core.ifc.M3ElementIfc theElement) throws EAIException {
    ...
    if( aElement != null) {
      aElement.removeCommentsPrivileged( theCtxt, this);
    ...
    if( theElement != null) {
      ...
      aNewElement.addCommentsPrivileged( theCtxt, this);
...
/****************************************************************************
 *  Implementation of  internal destructor of M3Comment
 ****************************************************************************/
  public void deletePR( EAIMMCtxtIfc theCtxt)  throws EAIException {
    ...
    super.deletePR( theCtxt);
      ...
      // When deleting : unreference attribute Text
  setText( theCtxt, null);
 ...
 ****************************************************************************/
  public static com.dosmil_e.m3.core.ifc.M3TypeIfc getStaticM3Type( EAIMMCtxtIfc theCtxt) {
    if( vm3Type == null) {
      vm3Type = com.dosmil_e.m3.core.meta.M3CommentMeta.getStaticM3Type( theCtxt);
    }
    return vm3Type;
  }
